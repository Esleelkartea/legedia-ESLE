...
/**
 * This class adds structure of 'trans_unit' table to 'legedia' DatabaseMap object.
 *
 *
...
class TransUnitMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('CAT_ID', 'CatId', 'INTEGER', 'catalogue', 'CAT_ID', false, null);

		$tMap->addColumn('ID', 'Id', 'VARCHAR', false, 255);

		$tMap->addColumn('SOURCE', 'Source', 'LONGVARCHAR', false, null);
		...
		$tMap->addColumn('TRANSLATED', 'Translated', 'INTEGER', false, null);
