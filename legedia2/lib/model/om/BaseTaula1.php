...
/**
 * Base class that represents a row from the 'taula1' table.
 *
 * 
 *
 ...
 */
abstract class BaseTaula1 extends BaseObject  implements Persistent {


  const PEER = 'Taula1Peer';
	...
	/**
	 * Initializes internal state of BaseTaula1 object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [t1id] column value.
	 * 
	 * @return     string
	 */
	public function getT1id()
	{
		return $this->t1id;
	}
	...
	/**
	 * Set the value of [t1id] column.
	 * 
	 * @param      string $v new value
	 * @return     Taula1 The current object (for fluent API support)
	 */
	public function setT1id($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->t1id !== $v) {
			$this->t1id = $v;
			$this->modifiedColumns[] = Taula1Peer::T1ID;
		}
	...
	public function setActividad($v)
	{
		...
		if ($this->actividad !== $v) {
			$this->actividad = $v;
			$this->modifiedColumns[] = Taula1Peer::ACTIVIDAD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->t1id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = Taula1Peer::NUM_COLUMNS - Taula1Peer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Taula1 object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Taula1Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseTaula1:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTaula1:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTaula1:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTaula1:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			Taula1Peer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Taula1Peer::doInsert($this, $con);
					...
					$affectedRows += Taula1Peer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Taula1Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Taula1Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Taula1Peer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getT1id(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setT1id($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Taula1Peer::T1ID)) $criteria->add(Taula1Peer::T1ID, $this->t1id);
		if ($this->isColumnModified(Taula1Peer::ACTIVIDAD)) $criteria->add(Taula1Peer::ACTIVIDAD, $this->actividad);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Taula1Peer::T1ID, $this->t1id);
	...
	/**
	 * Generic method to set the primary key (t1id column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Taula1 (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Taula1 Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Taula1 has previously been saved, it will retrieve
	 * related Empresas from storage. If this Taula1 is new, it will return
		...
		if ($this->collEmpresas === null) {
			if ($this->isNew()) {
			   $this->collEmpresas = array();
				...
				$criteria->add(EmpresaPeer::ID_ACTIVIDAD, $this->t1id);
	 ...
	 * Otherwise if this Taula1 is new, it will return
	 * an empty collection; or if this Taula1 has previously
	 * been saved, it will retrieve related Empresas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Taula1.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTaula1:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTaula1::%s', $method));
    }
