...
abstract class BaseMensaje extends BaseObject  implements Persistent {
  ...
  const PEER = 'MensajePeer';
	...
	/**
	 * The value for the cuerpo field.
	 * @var        string
	 */
	protected $cuerpo;
	...
	/**
	 * Initializes internal state of BaseMensaje object.
	 * @see        applyDefaults()
	 */
	...
	public function setIdMensaje($v)
	{
		...
		if ($this->id_mensaje !== $v) {
			$this->id_mensaje = $v;
			$this->modifiedColumns[] = MensajePeer::ID_MENSAJE;
		}
	...
	public function setIdUsuario($v)
	{
		...
		if ($this->id_usuario !== $v) {
			$this->id_usuario = $v;
			$this->modifiedColumns[] = MensajePeer::ID_USUARIO;
		}
	...
	/**
	 * Set the value of [cuerpo] column.
	 * 
	 * @param      string $v new value
	 * @return     Mensaje The current object (for fluent API support)
	 */
	public function setCuerpo($v)
	{
		...
		if ($this->cuerpo !== $v) {
			$this->cuerpo = $v;
			$this->modifiedColumns[] = MensajePeer::CUERPO;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MensajePeer::FECHA;
			}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = MensajePeer::EMAIL;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MensajePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cuerpo = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->fecha = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->email = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->created_at = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->updated_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->borrado = ($row[$startcol + 8] !== null) ? (boolean) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = MensajePeer::NUM_COLUMNS - MensajePeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isModified() && !$this->isColumnModified(MensajePeer::UPDATED_AT))
    {
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setIdMensaje($pk);  //[IMV] update autoincrement primary key
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getCuerpo(),
			$keys[4] => $this->getFecha(),
			$keys[5] => $this->getEmail(),
			$keys[6] => $this->getCreatedAt(),
			$keys[7] => $this->getUpdatedAt(),
			$keys[8] => $this->getBorrado(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setCuerpo($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setFecha($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setEmail($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCreatedAt($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setUpdatedAt($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setBorrado($arr[$keys[8]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MensajePeer::ID_MENSAJE)) $criteria->add(MensajePeer::ID_MENSAJE, $this->id_mensaje);
		if ($this->isColumnModified(MensajePeer::ID_USUARIO)) $criteria->add(MensajePeer::ID_USUARIO, $this->id_usuario);
		if ($this->isColumnModified(MensajePeer::ASUNTO)) $criteria->add(MensajePeer::ASUNTO, $this->asunto);
		if ($this->isColumnModified(MensajePeer::CUERPO)) $criteria->add(MensajePeer::CUERPO, $this->cuerpo);
		if ($this->isColumnModified(MensajePeer::FECHA)) $criteria->add(MensajePeer::FECHA, $this->fecha);
		if ($this->isColumnModified(MensajePeer::EMAIL)) $criteria->add(MensajePeer::EMAIL, $this->email);
		if ($this->isColumnModified(MensajePeer::CREATED_AT)) $criteria->add(MensajePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(MensajePeer::UPDATED_AT)) $criteria->add(MensajePeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MensajePeer::ID_MENSAJE, $this->id_mensaje);
	...
	/**
	 * Generic method to set the primary key (id_mensaje column).
	 *
	 ...
	 * Otherwise if this Mensaje has previously been saved, it will retrieve
	 * related MensajeDestinos from storage. If this Mensaje is new, it will return
	 ...
	 */
	public function getMensajeDestinosJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(MensajePeer::DATABASE_NAME);
		}
		...
		if ($this->collMensajeDestinos === null) {
			if ($this->isNew()) {
				...
				$this->collMensajeDestinos = MensajeDestinoPeer::doSelectJoinUsuario($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
