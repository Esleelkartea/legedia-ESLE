...
abstract class BaseCatalogue extends BaseObject  implements Persistent {
  ...
  const PEER = 'CataloguePeer';
	...
	/**
	 * The value for the nvisible field.
	 * @var        string
	 */
	protected $nvisible;
	...
	/**
	 * @var        array TransUnit[] Collection to store aggregation of TransUnit objects.
	 */
	protected $collTransUnits;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTransUnits.
	 */
	...
	/**
	 * Get the [nvisible] column value.
	 * 
	 * @return     string
	 */
	public function getNvisible()
	{
	...
	/**
	 * Set the value of [nvisible] column.
	 * 
	 * @param      string $v new value
	 * @return     Catalogue The current object (for fluent API support)
	 */
	public function setNvisible($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->nvisible !== $v) {
			$this->nvisible = $v;
			$this->modifiedColumns[] = CataloguePeer::NVISIBLE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nvisible = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->source_lang = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->target_lang = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->date_created = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->date_modified = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			return $startcol + 8; // 8 = CataloguePeer::NUM_COLUMNS - CataloguePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[1] => $this->getNvisible(),
			$keys[2] => $this->getName(),
			$keys[3] => $this->getSourceLang(),
			$keys[4] => $this->getTargetLang(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setNvisible($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setName($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setSourceLang($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setTargetLang($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CataloguePeer::NVISIBLE)) $criteria->add(CataloguePeer::NVISIBLE, $this->nvisible);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNvisible($this->nvisible);
	...
	/**
	 * Clears out the collTransUnits collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	{
		$this->collTransUnits = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTransUnits collection (array).
	 *
	 * By default this just sets the collTransUnits collection to an empty array (like clearcollTransUnits());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	...
	/**
	 * Gets an array of TransUnit objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Catalogue has previously been saved, it will retrieve
	 * related TransUnits from storage. If this Catalogue is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	...
	/**
	 * Returns the number of related TransUnit objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related TransUnit objects.
	 * @throws     PropelException
	 */
	...
	/**
	 * Method called to associate a TransUnit object to this object
	 * through the TransUnit foreign key attribute.
	 *
	 * @param      TransUnit $l TransUnit
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTransUnit(TransUnit $l)
	{
		...
		if (!in_array($l, $this->collTransUnits, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTransUnits, $l);
			$l->setCatalogue($this);
		}
	}
