...
abstract class BaseGrupoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdGrupo', 'Nombre', 'Padre', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idGrupo', 'nombre', 'padre', ),
		BasePeer::TYPE_COLNAME => array (self::ID_GRUPO, self::NOMBRE, self::PADRE, ),
		BasePeer::TYPE_FIELDNAME => array ('id_grupo', 'nombre', 'padre', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdGrupo' => 0, 'Nombre' => 1, 'Padre' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idGrupo' => 0, 'nombre' => 1, 'padre' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID_GRUPO => 0, self::NOMBRE => 1, self::PADRE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id_grupo' => 0, 'nombre' => 1, 'padre' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(GrupoPeer::ID_GRUPO);

		$criteria->addSelectColumn(GrupoPeer::NOMBRE);

		$criteria->addSelectColumn(GrupoPeer::PADRE);
    ...
    foreach (sfMixer::getCallables('BaseGrupoPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseGrupoPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseGrupoPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseGrupoPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(GrupoPeer::ID_GRUPO) && $criteria->keyContainsValue(GrupoPeer::ID_GRUPO) ) {
    ...
    foreach (sfMixer::getCallables('BaseGrupoPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(GrupoPeer::ID_GRUPO);
			$selectCriteria->add(GrupoPeer::ID_GRUPO, $criteria->remove(GrupoPeer::ID_GRUPO), $comparison);
	...
	/**
	 * Method to DELETE all rows from the grupo table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(GrupoPeer::ID_GRUPO, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(GrupoPeer::ID_GRUPO, $pk);
