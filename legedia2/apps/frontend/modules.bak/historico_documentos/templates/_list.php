...
<?php include_partial('list_td_tabular', array('historico_documento' => $historico_documento)) ?>
<?php include_partial('list_td_actions', array('historico_documento' => $historico_documento)) ?>
</tr>
<?php endforeach; ?>
</tbody>
<tfoot>
