  ...
  <th id="sf_admin_list_th_nombre_fich">
      ...
      <?php echo link_to(__('Nombre del fichero'), 'historico_documentos/list?sort=nombre_fich&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/historico_documento/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'sf_admin/historico_documento/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('Nombre del fichero'), 'historico_documentos/list?sort=nombre_fich&type=asc') ?>
      <?php endif; ?>
          </th>
  <th id="sf_admin_list_th_tamano">
          <?php if ($sf_user->getAttribute('sort', null, 'sf_admin/historico_documento/sort') == 'tamano'): ?>
      <?php echo link_to(__('Tamano'), 'historico_documentos/list?sort=tamano&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/historico_documento/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'sf_admin/historico_documento/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('Tamano'), 'historico_documentos/list?sort=tamano&type=asc') ?>
      <?php endif; ?>
          </th>
