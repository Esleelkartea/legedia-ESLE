...
<?php include_partial('usuarios/edit_messages', array('usuario' => $usuario, 'labels' => $labels)) ?>
<?php include_partial('usuarios/edit_form', array('usuario' => $usuario, 'labels' => $labels)) ?>
</div>
