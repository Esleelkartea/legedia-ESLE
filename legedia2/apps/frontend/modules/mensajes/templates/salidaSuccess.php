...
<h1><?php echo __('Bandeja de salida', array()) ?></h1>
...
<?php else: ?>
<?php include_partial('salida', array('pager' => $pager , 'labels' => $labels)) ?>
<?php endif; ?>
<?php include_partial('list_actions') ?>
</div>

<div id="sf_admin_bar">
<?php include_partial('filters_salida', array('filters' => $filters)) 
?>
</div>
